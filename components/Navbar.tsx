  ...
  return (
    <div className={styles.navbar_container} style={{ display: display }}>
      <div className={styles.nav_menu}>
        <ul className='p-0'>
          <li><Link href="/home" className='text-decoration-none d-flex justify-content-center flex-column'><a className='text-decoration-none mx-auto d-flex flex-column justify-content-center'><IconButton style={{ paddingTop: "10px" }}><HomeIcon style={{ color: "#8C8C8E" }} /></IconButton><p style={{ paddingBottom: "10px" }}>Home</p></a></Link></li>
